...
.PHONY: build
build:
	go install github.com/ZhongsJie/nilaway/cmd/nilaway
...
.PHONY: golden-test
golden-test:
	@cd tools && go install github.com/ZhongsJie/nilaway/tools/cmd/golden-test
	@$(GOBIN)/golden-test $(ARGS)

.PHONY: integration-test
integration-test:
	@cd tools && go install github.com/ZhongsJie/nilaway/tools/cmd/integration-test
...
nilaway-lint: build
	@$(foreach mod,$(MODULE_DIRS), \
		...
		$(GOBIN)/nilaway -include-pkgs="github.com/ZhongsJie/nilaway" ./...) &&) true
